  ...
  ru: {
    ...
    signal: {
      ...
      cards: [
        ...
        { code: "06", k: "Отвечаю за результат", v: "Не «сдал и пропал» — довожу до рабочего продукта и остаюсь на связи", tail: "до результата" },
      ],
    },
    about: {
      eyebrow: "Profile",
  ...
  en: {
    ...
    signal: {
      ...
      cards: [
        ...
        { code: "06", k: "I own the result", v: "Not “ship and vanish” — I take it to a working product and stay in touch", tail: "to the result" },
      ],
    },
    about: {
      eyebrow: "Profile",
  ...
  uz: {
    ...
    signal: {
      ...
      cards: [
        ...
        { code: "06", k: "Natija uchun javob beraman", v: "«Topshirib g'oyib bo'lish» emas — ishlaydigan mahsulotga yetkazaman va aloqada qolaman", tail: "natijagacha" },
      ],
    },
    about: {
      eyebrow: "Profil",
