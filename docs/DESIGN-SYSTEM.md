...
В первой сцене Proof Rail материализован как `Release Gate`: rough graphite
входит в оптическую рамку контроля и выходит законченным модулем. Это единый
предметный мотив Intro, Hero и chapter preview меню, а не три несвязанных
декоративных изображения.
...
|---:|---|---|---|
| 01 | `hero` | продуктовый тезис, авторство и ownership loop | proposition-led Release Gate; full-stage desktop и самостоятельная mobile camera с видимым переходом в Signal |
