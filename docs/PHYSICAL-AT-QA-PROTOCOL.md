...
Актуализировано для локального кандидата: `v2.14.1 / v237`, 2026-08-18. В
evidence записывается только фактически открытый
production SHA; до публикации V3 все сценарии ниже остаются `NOT RUN`.
...
## 7. Визуальная приёмка 12 секций, меню и 19 кейсов

На iPhone и Android пройти все 12 глав главной, fullscreen-меню и все 19 case route хотя бы в RU;
