...
function validateTruthAndLanguage(content, landings) {
  ...
  const authored = [
    ...
    "src/projects/landings-data.js", "src/projects/landings-new.js", "src/projects/render.js",
  ];
...
function validateRuntimeShell(generated) {
  ...
  assert(deployWorkflow.includes("git status --porcelain --untracked-files=all -- index.html src/components projects sitemap.xml"), "deployment must reject tracked and untracked generated drift");
